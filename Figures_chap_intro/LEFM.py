...
xx,yy,xy = full_epsilon_mode_I(time,args,PlaneStress=False,constants=constants)
xxp,yyp,xyp = full_epsilon_mode_I(time,args,PlaneStress=True,constants=constants)
v,y_pos,t_0,Gamma=args
...
fig.savefig(main_folder + "Figures_chap_intro/LEFM_plot.png",dpi=dpi_global)
fig.savefig(main_folder + "Figures_chap_intro/LEFM_plot.pdf")
fig.savefig(main_folder + "Figures_chap_intro/LEFM_plot.svg")
fig.show()
plt.close('all')
